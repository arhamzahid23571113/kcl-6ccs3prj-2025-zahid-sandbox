...
This project was structured so that the report could be rebuilt from version-controlled sources
and imported generated assets.
...
\texttt{report/figures/final\_pack/} and \texttt{report/tables/final\_pack/}.
