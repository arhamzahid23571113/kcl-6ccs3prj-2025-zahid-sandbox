...
Markdown summary files, report-ready tables, report-ready figures, and run logs stored in the
repository.

The evidence chain used for the report can be summarised as follows:

\begin{itemize}
  \item Raw attack outputs and supporting run logs are stored in the frozen pack under \path{results/final_pack/}.
  \item Explanation outputs for the reported 10k runs are stored as frozen CSV artefacts under \path{results/final_pack/}.
  \item Aggregated summaries and comparison narratives are stored as frozen Markdown artefacts under \path{results/final_pack/}.
  \item Report-ready figures are stored under \path{report/figures/final_pack/}.
  \item Report-ready tables are stored under \path{report/tables/final_pack/}.
...
\nolinkurl{results/final_pack/de1px_rise_guided_10000.log} & Frozen execution log for the 10k RISE-guided attack run reported in RQ2. \\
\nolinkurl{results/final_pack/explanations_10000_rise_guided_gpu.log} & Frozen execution log for the 10k RISE-guided explanation pass. \\
...
\input{../report/tables/final_pack/rq2_attack_summary.tex}
\clearpage

\input{../report/tables/final_pack/rq2_stability_means.tex}
\clearpage

\input{../report/tables/final_pack/rq2_del_delta_means.tex}
\clearpage
